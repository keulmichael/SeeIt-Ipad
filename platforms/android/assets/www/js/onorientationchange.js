  function listenerTailleEcran(requeteMedia) {
	...
	document.getElementById('icone-seeit.png').style.width = '450px';	
      	document.getElementById('photoaccueil_1').style.width = '80%';
      	document.getElementById('photoaccueil_2').style.width = '80%';
      	document.getElementById('photoaccueil_3').style.width = '80%';
      	document.getElementById('pubaccueil_1').style.width = '80%';
      	document.getElementById('pubaccueil_2').style.width = '80%';
	} else {  
